...
<body>
    <div class="title">
        ...
        <div class="heading">
            <h1>Online Bus Ticketing System</h1>
        </div>
    </div>
    <div class="btn-group">
        <br>
    ...
    <div class="seatPlan">
        ...
        <form>
            <input type="button" value="A1" id="A1" onclick="book(this.id)" ;>
            <input type="button" value="A2" id="A2" onclick="book(this.id)" ;>&emsp;&emsp;
            <input type="button" value="A3" id="A3" onclick="book(this.id)" ;>
            <input type="button" value="A4" id="A4" onclick="book(this.id)" ;>
            <br><br>
            <input type="button" value="B1" id="B1" onclick="book(this.id);">
            <input type="button" value="B2" id="B2" onclick="book(this.id);">&emsp;&emsp;
            <input type="button" value="B3" id="B3" onclick="book(this.id);">
            <input type="button" value="B4" id="B4" onclick="book(this.id);">
            <br><br>
            <input type="button" value="C1" id="C1" onclick="book(this.id);">
            <input type="button" value="C2" id="C2" onclick="book(this.id);">&emsp;&emsp;
            <input type="button" value="C3" id="C3" onclick="book(this.id); ">
            <input type="button" value="C4" id="C4" onclick="book(this.id);">
            <br><br>
            <input type="button" value="D1" id="D1" onclick="book(this.id);">
            <input type="button" value="D2" id="D2" onclick="book(this.id);">&emsp;&emsp;
            <input type="button" value="D3" id="D3" onclick="book(this.id);">
            <input type="button" value="D4" id="D4" onclick="book(this.id);">
            <br><br>
            <input type="button" value="E1" id="E1" onclick="book(this.id);">
            <input type="button" value="E2" id="E2" onclick="book(this.id);">&emsp;&emsp;
            <input type="button" value="E3" id="E3" onclick="book(this.id);">
            <input type="button" value="E4" id="E4" onclick="book(this.id);">
            <br><br>
            <input type="button" value="F1" id="F1" onclick="book(this.id);">
            <input type="button" value="F2" id="F2" onclick="book(this.id);">&emsp;&emsp;
            <input type="button" value="F3" id="F3" onclick="book(this.id);">
            <input type="button" value="F4" id="F4" onclick="book(this.id);">
