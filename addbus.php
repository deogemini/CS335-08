...
<div class="heading"><h1 >Online Bus Ticketing System</h1></div>
	...
	<br>
        ...
        <a href="#ContactUs.php" class="button">Contact us</a>
        <a href="HowToPay.php" class="button">How to pay </a>
		<br><br><br><br><br>>>>>>>> 9c70c5651c8357af9943b02500613d63ad1c0c16
    </div>
...
<div class="container">
  ...
  <div id="main"></div>
  <form  class="whole-form" action="connect.php" method="POST" enctype="multipart/from-data" >
  ...
  <input type="text" id="date" placeholder="Bus number (T4342CWX)" name="number"><br>
  <label for="from">Class:</label><br>
  <input type="text" id="from" placeholder="Bus class" name="class"><br>
  <label for="to">Company:</label><br>
  <input type="number" id="to" placeholder="Bus company" name="company"><br>
  <label for="to">Departure time:</label><br>
  <input type="time" id="to" placeholder="HH/MM/SS" name="departure-time"><br><br>
  </div>
  ...
  <button class="submit-button" type="submit" name="submit">Save details</button>  <input type="text" id="date" placeholder="Bus number (TZ-4342)" name="number"><br>
  <label for="from">Class:</label><br>
